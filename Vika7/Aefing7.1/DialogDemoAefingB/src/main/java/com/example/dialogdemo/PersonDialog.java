...
public class PersonDialog extends Dialog<Person> {
	...
	//	OKCANCEL = new ButtonType("Í lagi ", ButtonBar.ButtonData.OK_DONE);
	...
	private void setPropertyBindings() {
		...
		addressField.textProperty().bindBidirectional(person.addressProperty());
	}
...
//Bættu við þriðja sviðinu í dialoginn og Person sem er address. Taktu skjáskot af dialognum.
		...
		GridPane.setHgrow(this.addressField, Priority.ALWAYS);
